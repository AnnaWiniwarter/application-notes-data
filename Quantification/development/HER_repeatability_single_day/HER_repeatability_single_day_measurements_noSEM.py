...
file_dict = {
    # "HERonPt_RnD1_noSEM_1-4": {
    #     "DIR": r"2022-06-27 11_37_36 HER_repetition_SEM_off",
    #     "ZIL": "2022-06-27 11_37_36 HER_repetition_SEM_off.tsv",
    #     "CV": "2022-06-27 11_37_36 HER_repetition_SEM_off_01_01_CVA_DUSB0_C01.mpt",
    #     "CP": "2022-06-27 11_37_36 HER_repetition_SEM_off_01_02_CP_DUSB0_C01.mpt",
    #     "cv_tspan": [1100, 2000],  # note: this is just a guess
    #     "cp_tspan": [0, 18000],
    #     "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in np.arange(4)],
    #     # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
    #     "tspan_bg_list": [[x + 4760 * y for x in [2680, 2780]] for y in np.arange(4)],
    # },
    # "HERonPt_RnD1_2": {
    ...
    # },
    "HERonPt_RnD1_noSEM_5+": {
        "DIR": r"2022-06-28 11_16_22 HER_repetition_SEM_off_3",
        ...
        "cv_tspan": [0, 1500],  # note: this is just a guess
        "cp_tspan": [0, 85000],
        "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in np.arange(20)],
        # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
        "tspan_bg_list": [[x + 4155 * y for x in [1930, 2030]] for y in np.arange(20)],
    },
}
