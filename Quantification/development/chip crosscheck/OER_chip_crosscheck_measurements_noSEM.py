...
# zilien_filename = "2022-03-16 10_41_29 OER_on_Pt_repeatability_test_1.tsv"
# biologic_filename_cv = "2022-03-16 10_41_29 OER_on_Pt_repeatability_test_1_04_01_CVA_DUSB0_C01.mpt"
# biologic_filename_cp = "2022-03-16 10_41_29 OER_on_Pt_repeatability_test_1_04_02_CP_DUSB0_C01.mpt"

file_dict = {
    # "OERonPt_RnD1_2019W4C5_noSEM_4+": {
    #     "DIR": r"OER on Pt repeatability\2022-06-29 16_23_31 OER_repetition_SEM_off_4",
    #     "ZIL": "2022-06-29 16_23_31 OER_repetition_SEM_off_4.tsv",
    #     "CV": "2022-06-29 16_23_31 OER_repetition_SEM_off_4_07_01_CVA_DUSB0_C01.mpt",
    #     "CP": "2022-06-29 16_23_31 OER_repetition_SEM_off_4_07_02_CP_DUSB0_C01.mpt",
    #     "cv_tspan": [0, 1500],  # note: this is just a guess
    #     "cp_tspan": [0, 65000],
    #     "Ns_lists": [
    #         [x + 16 * y for x in [6, 8, 10, 12, 14]] for y in [12, 13, 14]
    #     ],  # np.arange(15)
    #     # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
    #     "tspan_bg_list": [
    #         [x + 4155 * y for x in [2490, 2610]] for y in [12, 13, 14]
    #     ],  # np.arange(15)
    # },
    # "OERonPt_RnD1_2019W4D2_noSEM_1-2": {
    #     "DIR": r"HER OER chip crosscheck\2022-07-06 12_43_20 OER_chip crosscheck_SEM_off",
    #     "ZIL": "2022-07-06 12_43_20 OER_chip crosscheck_SEM_off.tsv",
    #     "CV": "2022-07-06 12_43_20 OER_chip crosscheck_SEM_off_01_01_CVA_DUSB0_C01.mpt",
    #     "CP": "2022-07-06 12_43_20 OER_chip crosscheck_SEM_off_01_02_CP_DUSB0_C01.mpt",
    #     "cv_tspan": [0, 1500],  # note: this is just a guess
    #     "cp_tspan": [0, 10000],
    #     "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in np.arange(2)],
    #     # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
    #     "tspan_bg_list": [[3580, 3640], [6526, 6580]],
    # },
    # "OERonPt_RnD1_2021bW1D3_noSEM_1-2": {
    #     "DIR": r"HER OER chip crosscheck\2022-07-06 19_26_18 OER_chip crosscheck_newchip_SEM_off",
    #     "ZIL": "2022-07-06 19_26_18 OER_chip crosscheck_newchip_SEM_off.tsv",
    #     "CV": "2022-07-06 19_26_18 OER_chip crosscheck_newchip_SEM_off_01_01_CVA_DUSB0_C01.mpt",
    #     "CP": "2022-07-06 19_26_18 OER_chip crosscheck_newchip_SEM_off_01_02_CP_DUSB0_C01.mpt",
    #     "cv_tspan": [0, 1500],  # note: this is just a guess
    #     "cp_tspan": [0, 10000],
    #     "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in np.arange(2)],
    #     # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
    #     "tspan_bg_list": [[1597, 1749], [5686, 5779]],
    # },
    "OERonPt_RnD1_2021bW2D3_noSEM_all": {
        "DIR": r"application note data\2022-07-19 10_02_32 AIO_HER_OER_2021bW2D3",
        "ZIL": "2022-07-19 10_02_32 AIO_HER_OER_2021bW2D3.tsv",
        "CV": "2022-07-19 10_02_32 AIO_HER_OER_2021bW2D3_01_03_CVA_DUSB0_C01.mpt",
        "CP": "2022-07-19 10_02_32 AIO_HER_OER_2021bW2D3_01_04_CP_DUSB0_C01.mpt",
        "cv_tspan": [0, 1500],  # note: this is just a guess
        "cp_tspan": [0, 10000],
        "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in [0, 1, 2]],
        # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
        "tspan_bg_list": [[6518, 6662], [14829, 14986], [23114, 23311]],
    },
}
...
def plot_and_calibrate(
    ...
    axes_c = cps.plot_measurement(mass_list=[mass])
    ...
    print(cal_type + "calibration factor F= {:.3f}".format(cal[0].F))
    cal[1].annotate(
...
def value_diff_t_list(data, tstamp_list, value_name_list, plot=True):
    ...
    for value_name in value_name_list:
        values = [
            np.average(data.grab(value_name, tspan=[tstamp - 15, tstamp + 15])[1])
            for tstamp in time
        ]
        values_diff = [
...
for file in file_dict:
    ...
    if WHICH_PART == "import_only":
        ...
        o2_F_and_tstamp_list = o2_F_and_tstamp_list + main()
# Now plot the time development of F
x = [x for x in np.arange(len(o2_F_and_tstamp_list))]
namelist = [
    "2019W4C5",
    "2019W4C5",
    "2019W4C5",
...
Fs = [o2_F_and_tstamp_list[x][0].F for x in np.arange(len(o2_F_and_tstamp_list))]
fig1, ax1 = plt.subplots()
ax1.plot(
    x,
    Fs,
...
plt.tight_layout()
# fig1.savefig("./F_OER_chip_crosscheck.png")

np.savetxt(
    "./F_OER_2021bW2D3.csv", np.array([namelist, Fs]), delimiter=", ", fmt="%s",
)
