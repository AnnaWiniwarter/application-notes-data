...
PARENT_PATH = Path(
    r"C:\Users\AnnaWiniwarter\Dropbox (Spectro Inlets)\Development\Data\Quantification Application Note\OER on Pt repeatability"
)
...
file_dict = {
    # "OERonPt_RnD1_noSEM_1-3": {
    #     "DIR": r"2022-06-29 10_58_01 OER_repetition_SEM_off_2",
    #     "ZIL": "2022-06-29 10_58_01 OER_repetition_SEM_off_2.tsv",
    #     "CV": "2022-06-29 10_58_01 OER_repetition_SEM_off_2_01_01_CVA_DUSB0_C01.mpt",
    #     "CP": "2022-06-29 10_58_01 OER_repetition_SEM_off_2_01_02_CP_DUSB0_C01.mpt",
    #     "cv_tspan": [1100, 2000],  # note: this is just a guess
    #     "cp_tspan": [0, 13000],
    #     "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in np.arange(3)],
    #     # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
    #     "tspan_bg_list": [[x + 4150 * y for x in [2000, 2100]] for y in np.arange(3)],
    # },
    # "HERonPt_RnD1_2": {
    ...
    # },
    "OERonPt_RnD1_noSEM_4+": {
        "DIR": r"2022-06-29 16_23_31 OER_repetition_SEM_off_4",
        ...
        "cv_tspan": [0, 1500],  # note: this is just a guess
        "cp_tspan": [0, 65000],
        "Ns_lists": [[x + 16 * y for x in [6, 8, 10, 12, 14]] for y in np.arange(15)],
        # "tspan_list": [[1396, 1496], [1983, 2102], [2582, 2701], [3188, 3288], [3780, 3899]],
        "tspan_bg_list": [[x + 4155 * y for x in [2490, 2610]] for y in np.arange(15)],
    },
}
...
time_abs = [o2_F_and_tstamp_list[x][1] for x in np.arange(len(o2_F_and_tstamp_list))]
